# Modelling DBH x Height {#sec-model_dbh_h}

## Introduction

Permanent plot data lack total height, a critical variable for accurately estimating biomass. We obtained total heights for a subset of trees using LiDAR data (see @sec-height_from_lidar). Additionally, we have other Forest Inventories conducted in the Jamari National Forest that include both DBH and total height.
...
Merging two datasets (@dos-Santos2022 and IFN) in a standardized data frame.
