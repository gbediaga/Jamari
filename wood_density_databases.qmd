---
title: "Comparing wood density databases"
author: "G. Bediaga"
date: last-modified
format: 
  html:
...
This script will compare biomass estimations with different wood density databases. 
We will use Global Wood Database [@Chave2009], from the package `BIOMASS` and the Brazilian Woods Database (<https://lpf.florestal.gov.br/en-us/brazilian-woods>). 
